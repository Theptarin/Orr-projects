	...
	<div id="loginModal" class="modal show" tabindex="-1" role="dialog" aria-hidden="true">
	  ...
	  <div class="modal-content">
	      ...
	      <div class="modal-body">
	          <form class="form col-md-12 center-block" action="<?=site_url('Welcome/singin_check');?>" method="post">
	            ...
	            <div class="form-group">
	              <button class="btn btn-primary btn-lg btn-block" type="submit">Singin</button>
